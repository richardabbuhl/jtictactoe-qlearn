...
public class Train extends Player {
   ...
   static DecimalFormat decfmt1 = new DecimalFormat("#0.0");
   static DecimalFormat decfmt2 = new DecimalFormat("#00.0");
   static DecimalFormat decfmt3 = new DecimalFormat("#00.000");
